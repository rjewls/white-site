// Test script for El Tarf (Wilaya 36) communes with Noest API
...
// All communes for wilaya 36 (El Tarf)
const elTarfCommunes = [
  'El Tarf',
  'Bouhadjar',
  'Ben Mhidi',
  'Bougous',
...
async function testAllCommunes() {
  console.log('🧪 Testing El Tarf (Wilaya 36) communes with Noest API...');
  console.log(`📍 Total communes to test: ${elTarfCommunes.length}\n`);

  const results = [];
  
  for (const commune of elTarfCommunes) {
  ...
  if (successful.length === results.length) {
    ...
    console.log('✅ El Tarf wilaya is ready for production use.');
  }

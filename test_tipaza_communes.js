...
/**
 * Test communes for Tipaza (wilaya 42)
 * Testing the main city: Tipaza
 */
async function testTipazaCommunes() {
  console.log('🧪 Testing Tipaza communes with Noest API...\n');

  // Test main commune: Tipaza
  await testOrderCreation('Tipaza', 42);
}
...
// Run the test
testTipazaCommunes().then(() => {
  console.log('\n✨ Tipaza commune testing completed!');
}).catch(error => {

// Test script for Souk Ahras wilaya (41) communes with Noest API
...
async function testSoukAhrasCommunes() {
  console.log('\n🧪 Testing Souk Ahras (Wilaya 41) communes with Noest API...\n');
  ...
  const testCommunes = ['Souk Ahras', 'Sedrata', 'Mdaourouche'];

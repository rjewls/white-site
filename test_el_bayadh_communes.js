// Test script for El Bayadh (Wilaya 32) communes with Noest API
...
// All communes for wilaya 32 (El Bayadh)
const elBayadhCommunes = [
  'El Bayadh',
  'Rogassa',
  'Stitten', 
  'Brezina',
...
async function testAllCommunes() {
  console.log('🧪 Testing El Bayadh (Wilaya 32) communes with Noest API...');
  console.log(`📍 Total communes to test: ${elBayadhCommunes.length}\n`);

  const results = [];
  
  for (const commune of elBayadhCommunes) {

...
/**
 * Test communes for Naâma (wilaya 45)
 * Testing the main city: Naama
 */
async function testNaamaCommunes() {
  console.log('🧪 Testing Naâma communes with Noest API...\n');

  // Test main commune: Naama
  await testOrderCreation('Naama', 45);
}
...
// Run the test
testNaamaCommunes().then(() => {
  console.log('\n✨ Naâma commune testing completed!');
}).catch(error => {
